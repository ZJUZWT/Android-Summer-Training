...
public class Clock2View extends View {
	...
	public Clock2View(Context context) {
		super(context);
		init();
	}

	public Clock2View(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public Clock2View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
